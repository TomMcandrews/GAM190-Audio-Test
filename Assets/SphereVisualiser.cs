...
public class SphereVisualiser : MonoBehaviour // Inherits from MonoBehaviour, making it a script that can be attached to a GameObject.
{
    ...
    public float scaleSensitivity = 2.0f; // Controls how sensitive the scaling is to the amplitude of the music.
    ...
    public Color baseColorLeftSphere = Color.blue; // Example base color for a sphere reacting to bass.
    public Color baseColorRightSphere = Color.red; // Example base color for a sphere reacting to treble.
    ...
    void Start() // Start is called before the first frame update.
    {
        ...
        material.color = reactToBass ? baseColorLeftSphere : baseColorRightSphere;
    }
    ...
    void ChangeColor(float amplitude, float bandValue)
    {
        ...
        Color targetColor = (reactToBass ? baseColorLeftSphere : baseColorRightSphere) * (1 + bandValue * amplitude);
